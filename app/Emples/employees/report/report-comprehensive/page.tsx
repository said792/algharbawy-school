...
import autoTable from 'jspdf-autotable'; // ✅ استيراد منفصل
  ...
  return (
    <div style={containerStyle}>
      ...
      <div style={{ display: 'flex', gap: '15px', flexWrap: 'wrap', marginBottom: '15px' }}>
        <div style={summaryCard('#fee2e2', '#991b1b')}>إجمالي الإجازات<br/><strong>{totals.leaves}</strong></div>
        <div style={summaryCard('#fef3c7', '#92400e')}>إجمالي الأذونات<br/><strong>{totals.permissions}</strong></div>
        <div style={summaryCard('#f3e8ff', '#6b21a8')}>إجمالي الجزاءات<br/><strong>{totals.penalties}</strong></div>
      </div>
